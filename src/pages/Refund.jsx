...
const RefundPolicy = () => {
  return (
    <div className="container mx-auto md:px-32 px-5 py-10 bg-gray-50 text-gray-800">
      ...
      <p className="mb-4">
        ...
        <a
          href="https://www.abacafootwear.com"
          className="text-blue-600 underline"
        >
          www.abacafootwear.com
        </a>
      </p>
      ...
      <ul className="list-disc list-inside mb-4">
        <li>
          ...
          "Us" or "Our" in this Agreement) refers to www.abacafootwear.com
        </li>
        <li>
        ...
        <li>
          <strong>Website:</strong> refers to www.stylogroupindia.com,
          accessible from www.abacafootwear.com
        </li>
        <li>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-4">Returning Goods</h2>
      <p className="mb-4">
      ...
      <address className="mb-4 not-italic">
        ABACA POLYMERS
        <br />
        11/544-D, Mamyalmathil, Kozhikodenkunnu, Olavanna PO, Kozhikode, Kerala-
        673019
        <br />
        <a
          href="mailto:abacapolymer@gamil.com"
